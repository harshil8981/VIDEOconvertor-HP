...
#  Copyright (c) 2021 harshil8981 ; All rights reserved. 
#
...
#
#  License can be found in < https://github.com/harshil8981/VIDEOconvertor-HP/blob/public/LICENSE> .
...
async def source(event):
    await event.edit(source_text,
                    buttons=[[
                         Button.url("FOR PERSONAL USE", url="https://github.com/harshil8981/VIDEOconvertor-HP/tree/main"),
                         Button.url("FOR YOUR CHANNEL ", url="https://github.com/harshil8981/VIDEOconvertor-HP/")]])
